...
- organizarea facultatilor, specializarilor si locurilor in esantioane de optiuni;
- asocierea esantioanelor de optiuni cu esantioanele de studenti;
- esantionul implicit de optiuni este `ASE 2023`;
- listarea, cautarea si actualizarea tuturor datelor primite prin formular;
- repartizarea candidatilor pe esantion de studenti si esantion de optiuni, cu algoritm ales din aplicatie;
- generarea unui esantion demo cu studenti fictivi;
- comutarea interfetei intre romana si engleza;
...
Alternativ, dupa compilare, poti porni aplicatia din `Admitere.bat`.
